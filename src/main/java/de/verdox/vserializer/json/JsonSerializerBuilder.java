            ...
            public void updateLiveObjectFromJson(@Nullable T existingObject, JsonElement jsonElement) {
                ...
                for (SerializableField<T, ?> field : constructorSerializer.getFields()) {
                    if(field.setter() != null)
                        field.setter().accept(existingObject, field.read(jsonObject));
                }
                fields.forEach((s, serializableField) -> {
                    Object value = serializableField.read(jsonObject);
                    if (serializableField.setter() != null)
